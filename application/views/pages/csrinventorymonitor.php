                 ...
                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body container-fluid">
                            <form id="search-csr-inventory-form"  method="POST" >
                             ...
                             <div class="col-sm-4">
                                 <button onclick="csr.search_inventory_monitoring()" type="button" class="btn bg-purple waves-effect">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-cyan" style="text-transform:uppercase;">
                            <h2>
                                CSR and Office Supplies: Inventory Monitoring
                            </h2>
                            
                        </div>
                        <div class="body table-responsive">
                            <form id="csr-inventory-form" action="<?= base_url("user/generate_inventory_monitoring_report/csr") ?>" method="POST" target="_blank">
                                ...
                                <a class="reports-btn" href="javascript:void(0)" target="_blank">
                                    <button  style="height: 25px" type="button" onclick="csr.generate_inventory_monitoring_report()" class="btn bg-pink waves-effect">
                           ...
                           <form id="total-data" >
                            ...
                            <table id="csr-inventory-table" class="table table-bordered table-striped table-hover" style="font-size: 11px;">
                                <thead >

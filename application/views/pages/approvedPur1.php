                        ...
                        <div class="header bg-green">
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-6">
                                    <h2>Purchase Records: Approved</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="body table-responsive">
                            ...
                            <table id="approved-supplier-table" class="table table-bordered table-striped table-hover">
                                <thead>
                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="body table-responsive">
                            ...
                            <table id="approved-stock-table" class="table table-bordered table-striped table-hover">
                                <thead>
                                    <tr style="font-size: 12px">
...
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function () {
        approved1.get_approved1();
        var sidemenu = $('#purchase-req-3');

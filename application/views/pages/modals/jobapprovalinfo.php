<!-- Large Size -->
<div class="modal fade" id="jobapprovalinfo" tabindex="-1" role="dialog" data-backdrop="static">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-cyan">
                    ...
                    <h4 class="modal-title" id="jobapprovalinfos" style="text-transform: uppercase;"></h4>
                </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="card">
                                    <div class="body table-responsive">
                                        ...
                                        <table id="asset-info-table" class="table table-bordered table-striped table-hover">
                                            <thead>

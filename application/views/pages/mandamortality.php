                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body container-fluid">
                            <form id="search-mortality-form"  method="POST" >
                            ...
                            <div class="col-sm-4">
                                <button onclick="mortality.search_mortality_census()" type="button" class="btn bg-purple waves-effect">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body table-responsive">
                            <table id="mortality-census-table" class="table table-bordered table-striped table-hover">
                                <thead>
                                    <tr >

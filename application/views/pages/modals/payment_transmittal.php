<!-- Large Size -->
<div class="modal fade" id="payment_transmittal" tabindex="-1" role="dialog" data-backdrop="static">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="payment_transmittal-info-form"><br>
                        <div class="col-sm-4">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="card">
                                    <div class="body table-responsive">
                                        <table id="payment_transmittal-info-table" class="table table-bordered table-striped table-hover">
                                            <thead>

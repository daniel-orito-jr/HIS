<!-- Large Size -->
<div class="modal fade" id="eclaimstat" tabindex="-1" role="dialog" data-backdrop="static">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header ">
                    ...
                    <h4 class="modal-title" style="text-transform: uppercase;">ECLAIMS STATUS (TRANSMITTED) </h4><small id='eclaimstatx'></small>
                </div>
...
<!--                                    <a class="report-btn" href="javascript:void(0)" target="_blank" >
                                    ...
                                    <table id="dashboard-eclaim-stat-table" class="table table-bordered table-striped table-hover">
                                        <thead>

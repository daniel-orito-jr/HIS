                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body container-fluid">
                            ...
                            <div class="col-sm-2">
                                <button onclick="deniedphic.search_phic_denied()" type="button" class="btn bg-purple waves-effect">
                        ...
                        <div class="body table-responsive">
                            <form id="phic-denied-form" action="<?= base_url("user/get_phic_denied_report") ?>" method="POST" target="_blank">
                                ...
                                <a class="reports-btn" href="javascript:void(0)" target="_blank">
                                    <button onclick="deniedphic.generate_phicdenied_report()" style="height: 25px" type="button" class="btn bg-pink waves-effect">
                                        <i style="margin-top: -25px;" class="material-icons">picture_as_pdf</i>
                                    </button>
                                </a>   
                            </form>
                            <table id="denied-table" class="table table-bordered table-striped table-hover">
                                <thead>

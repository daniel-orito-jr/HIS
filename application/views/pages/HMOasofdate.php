                 ...
                 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-cyan" style="text-transform:uppercase;">
                            ...
                            <p style="color:red;text-align:right;font-size:12px;">May take considerate amount of time. Please be patient!</p>
                        </div>
                        <div class="body container-fluid">
                            <form id="search-hmo-asofdate-form"  method="POST" >
                             ...
                             <div class="col-sm-4">
                                 <button onclick="hmo.search_hmo_asofdate()" type="button" class="btn bg-purple waves-effect">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-cyan" style="text-transform:uppercase;">
                            ...
                            <select class="form-control show-tick" data-live-search="true" id="hmolist" name="hmolist" onchange="hmo.search_hmo()">
                        ...
                        <form id="hmo-asofdate-form" action="<?= base_url("user/generate_HMO_asof_date_report") ?>" method="POST" target="_blank">
                                ...
                                <a class="reports-btn" href="javascript:void(0)" target="_blank">
                                    <button  style="height: 25px" type="button" onclick="hmo.generate_hmoasofdate_report()" class="btn bg-pink waves-effect">
                           ...
                           <form id="total-data">
                            ...
                            <table id="hmo-asofdate-table" class="table table-bordered table-striped table-hover">
                                <thead >
...
<script type="text/javascript">
    ...
    load_hmoasofdate_script("http://192.168.2.111:3777/drainwizv2/assets/vendors/js/responsive.js");
    var sidemenu = $('#hmo-ar-2');

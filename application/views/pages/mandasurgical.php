                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body container-fluid">
                            <form id="search-surgical-form"  method="POST" >
                            ...
                            <div class="col-sm-4">
                                <button onclick="surgical.search_surgical_output();" type="button" class="btn bg-purple waves-effect">
...
<!--                            <a href="<?= base_url('user/surgicalmerge') ?>" target="_blank" id="btnEdit" >
                            ...
                            <table id="surg-table" class="table table-bordered table-striped table-hover">
                                <thead>
                                    <tr >
                                        <th rowspan="2"><center>Surgical Procedures</center></th>

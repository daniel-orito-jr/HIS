<!-- Large Size -->
<div class="modal fade" id="radsales_group" tabindex="-1" role="dialog" data-backdrop="static">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="body table-responsive">
                                        <form id="rad-sales-group-form" action="<?= base_url("user/generate_rad_sales_detailed_group_report") ?>" method="POST" target="_blank" id="ph">
                                        ...
                                        <a class="report-btn" href="javascript:void(0)" target="_blank" >
                                            <button onclick="radiologysales.generate_sales_rad_group_report()" style="height: 25px" type="button" class="btn bg-pink waves-effect">
                                                <i style="margin-top: -25px;" class="material-icons">picture_as_pdf</i>
                                            </button>
                                        </a>
                                        
                                        <table id="rad-sales-group-table" class="table table-bordered table-striped table-hover" style="font-size:11px;">

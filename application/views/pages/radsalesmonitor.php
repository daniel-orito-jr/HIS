                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="home">
                                    <div class="body table-responsive">
                                        <form id="rad-sales-form" action="<?= base_url("user/generate_sales_monitoring_report/radiology") ?>" method="POST" target="_blank">
                                            <a class="reports-btn" href="javascript:void(0)" target="_blank">
                                                <button  style="height: 25px" type="button" onclick="radiologysales.generate_sales_monitoring_report()" class="btn bg-pink waves-effect">
                                                    <i style="margin-top: -25px;" class="material-icons">picture_as_pdf</i>
                                                </button>
                                            </a> 
                                        </form>
                                        <table id="rad-sales-table" class="table table-bordered table-striped table-hover" style="font-size: 11px;">
                                            <thead>
                                                <tr>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="profile">
                                    ...
                                    <div class="body table-responsive">
                                        <form id="rad-summarized-form" action="<?= base_url("user/generate_sales_rad_summarized_report") ?>" method="POST" target="_blank">
                                            <input type="hidden" id="batch" name="batch"/>
                                            <input type="hidden" id="indate" name="indate"/>
                                            <input type="hidden" id="outdate" name="outdate"/>
                                            <a class="reports-btn" href="javascript:void(0)" target="_blank">
                                                <button  style="height: 25px" type="button" onclick="radiologysales.generate_sales_summarized_report()" class="btn bg-pink waves-effect">
                                                    <i style="margin-top: -25px;" class="material-icons">picture_as_pdf</i>
                                                </button>
                                            </a> 
                                        </form>
                                        <table id="rad-summarized-table" class="table table-bordered table-striped table-hover" style="font-size: 11px;">
                                            <thead>
                                                <tr>

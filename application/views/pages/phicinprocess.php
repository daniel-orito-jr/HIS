                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body container-fluid">
                            ...
                            <div class="col-sm-2">
                                <button onclick="inprocessphic.search_phic_in_process()" type="button" class="btn bg-purple waves-effect">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-cyan" style="text-transform:uppercase;">
                            <h2>
                                In Process Claims for the Month
                            </h2>
                        </div>
                        <div class="body table-responsive">
                            <form id="phic-in-process-form" action="<?= base_url("user/get_phic_inprocess_report") ?>" method="POST" target="_blank">
                            ...
                            <table id="in-process-table" class="table table-bordered table-striped table-hover">
                                <thead>

<!-- Large Size -->
    <div class="modal fade" id="classificationinformation" tabindex="-1" role="dialog" data-backdrop="static">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="card">
                                    <div class="body table-responsive">
                                        <form id="class-info-form" action="<?= base_url("user/generate_class_info_report") ?>" method="POST" target="_blank">
                                        ...
                                        <a class="report-class-info" href="javascript:void(0)" target="_blank" >
                                            <button onclick="user.generate_class_info_report()" style="height: 25px" type="button" class="btn bg-pink waves-effect">
                                                <i style="margin-top: -25px;" class="material-icons">picture_as_pdf</i>
                                            </button>
                                        </a>
                                        <table id="classification-info-table" class="table table-bordered table-striped table-hover">
                                            <thead>

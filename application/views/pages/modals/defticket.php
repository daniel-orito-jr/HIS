<!-- Large Size -->
    <div class="modal fade" id="defticket" tabindex="-1" role="dialog" data-backdrop="static">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer bg-orange">
                    ...
                    <div class="col-md-12">
                            ...
                            <button type="button" onclick="voucher.deffer()" class="btn btn-link waves-effect">SAVE</button>
                    </div>

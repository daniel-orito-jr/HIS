                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body container-fluid">
                            ...
                            <div class="col-sm-2">
                                <button onclick="returnphic.search_phic_return()" type="button" class="btn bg-purple waves-effect">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header bg-cyan" style="text-transform:uppercase;">
                            <h2>
                                Return Claims for the Month
                            </h2>
                        </div>
                        <div class="body table-responsive">
                            <form id="phic-return-form" action="<?= base_url("user/generate_phic_return_report") ?>" method="POST" target="_blank">
                                <input type="hidden" name="s_date" />
                                <a class="reports-btn" href="javascript:void(0)" target="_blank">
                                    <button onclick="returnphic.generate_phicreturn_report()" style="height: 25px" type="button" class="btn bg-pink waves-effect">

                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body container-fluid">
                            <form id="search-ph-inventory-form"  method="POST" >
                            ...
                            <div class="col-sm-4">
                                <button onclick="pharmacy.search_inventory_monitoring()" type="button" class="btn bg-purple waves-effect">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body table-responsive">
                            <form id="ph-inventory-form" action="<?= base_url("user/generate_inventory_monitoring_report/pharmacy") ?>" method="POST" target="_blank">
                                ...
                                <a class="reports-btn" href="javascript:void(0)" target="_blank">
                                    <button  style="height: 25px" type="button" onclick="pharmacy.generate_inventory_monitoring_report()" class="btn bg-pink waves-effect">
                            ...
                            <table id="ph-inventory-table" class="table table-bordered table-striped table-hover" style="font-size: 11px;">
                                <thead >
...
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function () {
        ...
        var sidemenu = $('#inventory-pharmacy');

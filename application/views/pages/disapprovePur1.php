                        ...
                        <div class="header bg-red">
                            <div class="row clearfix">
                                <div class="col-xs-12 col-sm-6">
                                    <h2>Purchase Records: Disapproved</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="body table-responsive">
                            ...
                            <table id="disapproved-supplier-table" class="table table-bordered table-striped table-hover">
                                <thead>
                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="body table-responsive">
                            ...
                            <table id="disapproved-stock-table" class="table table-bordered table-striped table-hover">
                                <thead>
                                    <tr style="font-size: 12px">
